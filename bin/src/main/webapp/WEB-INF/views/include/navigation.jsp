	  ...
	  <div class="header-content navbar navbar-expand navbar-white navbar-light" style="width:1280px; margin:0 auto;">
	    ...
	    <ul class="navbar-nav ml-auto">
	     ...
	     <li class="nav-item" id="dropdown">
	     	...
	     	<c:if test="${!empty loginUser.face_photo  }">
		          <img src="<%=request.getContextPath() %>/organogram/getPicture.do?picture=${loginUser.face_photo }" class="img-circle elevation-2" alt="User Image" style="width : 25px; height : 25px; ">
	     	</c:if>
