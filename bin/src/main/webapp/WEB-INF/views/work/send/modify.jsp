				...
				<div class="card-outline">
					<div class="card-header">
						<div style="display:inline;">
						    <div style="display:inline;">
							    ...
							    <span style="color:#556278;"><fmt:formatDate value="${job.regist_de }" pattern="yyyy-MM-dd" /></span>
						    </div>
						</div>
					...
					<div class="card-body pad">
						...
						<form enctype="multipart/form-data" role="form" method="post" action="modify.do" name="modifyForm">
							<input type="hidden" id="empno" readonly name="empno" value="${job.drctr_empno }">
							<input type="hidden" name="job_no" value="${job.job_no}" />
							<div class="form-group" id="group-1">
								<label for="emp_nm">작성자</label> 
								<input type="text" id="emp_nm" readonly name="emp_nm" class="form-control" value="${job.emp_nm }">
							</div>
