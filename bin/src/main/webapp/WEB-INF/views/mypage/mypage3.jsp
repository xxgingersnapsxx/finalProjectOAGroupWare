...
<!-- 	    		<button type="button" class="btn btn-primary" style="display: inline; position: absolute; left: 180px; font-size: 11px; padding: 3px 8px;">사원</button> -->
	    		<small class="badge badge-secondary" style="padding: 5px 8px; background: #419EDD"> 사원 </small>
	    		<br><br>
			...
			<div style="text-align: center;">
	    		<small class="badge badge-secondary" style="padding: 5px 8px;"> IP </small>&nbsp;192.168.0.1.1<br>
			              	...
			              	<table>
			              		<tr>
			              			<td>
						                ...
						                <span class="info-box-number"><p style="color: #2a9df4; font-weight:bold; display: inline;">1</p> 회</span>
			              			</td>
			              			<td>
			              			...
			              			<td>
						                ...
						                <span class="info-box-number"><p style="color: #dc143c; font-weight:bold; display: inline;">1</p> 회</span>
			              			</td>
			              			<td>
