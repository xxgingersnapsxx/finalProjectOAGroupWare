...
<%session.setAttribute("path", request.getContextPath() + "/board/news"); %>
		...
		<div class="container-fluid">
			<div class="row md-2">
				<div class="col-sm-6">
					...
					<p class="menu-header">회사 소식</p>
					<p class="menu-header">></p>
					<p class="menu-header this">회사 소식</p>
				</div>
		...
		<div class="gw-card">
			<div class="card-header with-border">
				<button type="button" class="btn btn-basic" id="registBtn"
					onclick="OpenWindow('news/registForm.do','회사소식 등록',900,800);">게시글등록</button>
				<div id="keyword" class="card-tools" style="width: 540px;">
					<div class="input-group row">
						...
						<span class="input-group-append">
							<button class="btn btn-basic" type="button" id="searchBtn" data-card-widget="search" onclick="list_go(1,'news');">
