				...
				<table class="table text-center" >					
					...
					<c:forEach items="${escMngtList}" var="escMngt">
						<tr style='font-size:0.85em;' >
							...
							<td id="boardTitle" onclick="javascript:OpenWindow('tempstorage/detail.do?sanctn_no=${escMngt.sanctn_no}','상세보기',800,960);">
							...
							<c:if test="${escMngt.ipcr_code eq '보통'}">
								<td style="color: blue;">${escMngt.ipcr_code}</td>	
							</c:if>						
							<c:if test="${escMngt.ipcr_code eq '긴급'}">
