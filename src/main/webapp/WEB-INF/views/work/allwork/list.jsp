...
<c:set var="jobList" value="${dataMap.jobList }" />

<%session.setAttribute("path", request.getContextPath() + "/work/allwork"); %>
		...
		<div class="container-fluid">
			<div class="row md-2">
				<div class="col-sm-6">
					...
					<p class="menu-header">전체 업무</p>
					<p class="menu-header">></p>
					<p class="menu-header this">전체 업무</p>
				</div>
				...
				<div id="keyword" class="card-tools" style="width: 540px;">
					<div class="input-group row">
						...
						<span class="input-group-append">
							<button class="btn btn-basic" type="button" id="searchBtn" data-card-widget="search" onclick="list_go3(1,'send');">
