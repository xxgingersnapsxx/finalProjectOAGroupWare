...
<body>
	...
	<div style="width: 1280px; margin: 0 auto;">
		<div class="wrapper">
		<div class="commute">		
			<a href="<%=request.getContextPath() %>/" style="font-family: 'Do Hyeon', sans-serif;color: #004680; font-size: 20px;">
			메인으로<i class="fa fa-arrow-right" aria-hidden="true"></i>
			</a>
		</div>
			<div class="row">
				<section class="col-md-6">
					<div class="pwlogin col-md-10">
						<button id="button1">출 근</button>
					</div>
				</section>
				<section class="col-md-6">
					<div class="facelogin col-md-10">
						<button id="button2">퇴 근</button>
					</div>
				</section>
			</div>
		...
		<div id="my_modal">
         ...
         <script>
            ...
            function takeSnapshot1() {
               var myCanvasElement = document.getElementById('myCanvas1');
               var myCTX = myCanvasElement.getContext('2d');
               myCTX.drawImage(myVideoStream1, 0, 0, myCanvasElement.width,
...
<!-- ====================================================================================================================================  -->
		...
		<div id="my_modal2">
         ...
         <div class="row" id="box1">
            ...
            <form id="frm1" method="post" action="http://127.0.0.1:5000/gohome">
               <input type="hidden" value="imgBase64" />
            </form>
         </div>
         <script>
            ...
            function server() {
               ...
               document.getElementById('frm1').append(input);
