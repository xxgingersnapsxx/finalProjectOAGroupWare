...
<c:set var="jobRecList" value="${dataMap.jobRecList }" />

<%session.setAttribute("path", request.getContextPath() + "/work/receive"); %>
		...
		<div class="container-fluid">
			<div class="row md-2">
				<div class="col-sm-6">
					...
					<p class="menu-header">받은 업무</p>
					<p class="menu-header">></p>
					<p class="menu-header this">받은 업무</p>
				</div>
				...
				<div id="keyword" class="card-tools" style="width: 540px;">
					<div class="input-group row">
						...
						<span class="input-group-append">
							<button class="btn btn-basic" type="button" id="searchBtn" data-card-widget="search" onclick="list_go4(1,'receive');">
			...
			<div class="card-body">
				<table class="table text-center">
					<tr style="font-size: 0.95em;">
						...
						<th style="width:35% height:20%;">진척도</th>
					</tr>
					...
					<c:forEach items="${jobRecList}" var="job" varStatus="st">
...
function list_go4(page,url){
	if(!url) url="work/receive/list.do";
