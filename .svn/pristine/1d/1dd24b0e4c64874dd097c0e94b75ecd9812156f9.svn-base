			...
			<div class="col-md-12" style="max-width:960px;">
				<div class="card-outline">
					<div class="card-header">
						...
						<c:if test="${loginUser.empno eq ctsn.empno }">
							<button type="button" id="modifyBtn" class="btn btn-regist" onclick="submit_go('modifyForm.do','${ctsn.bbsctt_no}');">수정</button>						
						    <button type="button" id="removeBtn" class="btn btn-remove" onclick="submit_go('remove.do','${ctsn.bbsctt_no}');">삭제</button>
						</c:if>
						...
						<div class="form-group col-sm-12">
						  <table class="table" >
						  	...
						  	<tr>
						  	  ...
						  	  <td colspan="3">${ctsn.sj}</td>
						  	</tr>
						  	<tr class="table-content">
						  	  <td class="table-th">내용</td>
						  	  <td colspan="3">${ctsn.cn}</td>
						  	</tr>
						  	<tr class="last-tr">
						  	    ...
						  	    <div class="row">
										<c:forEach items="${ctsn.atchList }" var="atch">
											<div class="col-md-4 col-sm-4 col-xs-12"  style="cursor:pointer;"
												 onclick="location.href='<%=request.getContextPath()%>/board/ctsn/getFile.do?file_no=${atch.file_no }';">
												<div class="info-box">	
				...
				<div class="top-button">
				    <a href="detail.do?bbsctt_no=${ctsn.bbsctt_no} ">top</a>
				</div>
