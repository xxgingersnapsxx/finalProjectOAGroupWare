				...
				<div class="card-outline">
					<div class="card-header">
						<div style="display:inline;">
						    <div style="display:inline;">
							    ...
							    <span style="color:#556278;"><fmt:formatDate value="${mngt.rgsde }" pattern="yyyy-MM-dd" /></span>
						    </div>
						</div>
					...
					<div class="card-body pad">
						...
						<form enctype="multipart/form-data" role="form" method="post" action="modify.do" name="modifyForm">
							<input type="hidden" id="empno" readonly name="empno" value="${mngt.empno }">
							<input type="hidden" name="bbsctt_no" value="${mngt.bbsctt_no}" />
							<div class="form-group" id="group-1">
								<label for="emp_nm">작성자</label> 
								<input type="text" id="emp_nm" readonly name="emp_nm" class="form-control" value="${mngt.emp_nm }">
							</div>
							<div class="form-group" id="group-2">
								<label for="sj">제&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;목</label> 
								<input type="text" id="sj" name="sj" class="form-control" value="${mngt.sj }">
							</div>							
							<div class="form-group" id="group-3">
							  <div style="margin: 0 auto; ">
								<label for="cn" id="label-3">내&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;용</label>
								<textarea class="textarea" name="cn" id="cn" rows="20"
									style="display: none;">${mngt.cn}</textarea>
							  </div>
							</div>
										...
										<ul class="mailbox-attachments d-flex align-items-stretch clearfix">
											...
											<li class="attach-item">																			
												<div class="mailbox-attachment-info">
													<a class="mailbox-attachment-name" name="attachedFile" attach-fileName="${atch.file_nm }" attach-no="${atch.file_no }" href="<%=request.getContextPath()%>/board/management/getFile.do?file_no=${atch.file_no }"  >													
