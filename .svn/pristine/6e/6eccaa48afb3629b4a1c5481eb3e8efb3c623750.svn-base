...
<c:set var="rdSendList" value="${dataMap.rdSendList }" />
			...
			<div class="card-body">
				<table class="table text-center">
					<tr style="font-size: 0.95em;">
						...
						<th style="width:20%;">결재 양식</th>
						<th style="width:30%;">제 목</th>
						<th style="width:10%;">제 목</th>
						<th style="width:15%;">승인 날짜</th>
						<th style="width:10%;">수신자</th>
					</tr>
					<c:if test="${empty rdSendList }">
						<tr>
							<td colspan="5"><strong>해당 내용이 없습니다.</strong></td>
						</tr>
					</c:if>
					<c:forEach items="${rdSendList}" var="escDbx">
